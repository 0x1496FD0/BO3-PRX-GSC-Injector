...
# Installation
  ...
  3. Drop your __.gscc__ files inside __/data/BO3 PRX GSC Injector__ (the folder is auto created on run if non existing) and rename them accordingly to follow the convention gscc_{__n__} where __n__ is the index of the script (__ex: gscc_0   gscc_1   gscc_2  ...__)
